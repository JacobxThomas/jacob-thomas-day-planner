// Moment day and time declaration 
moment(Date);
$("#currentDay").text(moment().format('dddd MMMM Do YYYY, h:mm a'));
// Moment Current time 
var currentTime = moment();
// Rounds current time to the nearest hour
currentTime = currentTime.startOf("hour");
// Calculates the start time to 9am
...
// Function to compare time slots with current time 
